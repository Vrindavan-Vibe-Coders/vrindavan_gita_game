  ...
  return (
	...
	<br />
      ...
      <p className="text-sm text-gray-700">
        Once you submit, we'll reveal how close you are. Green means this letter
        is in the right spot and has exactly the correct form.
      </p>
      ...
      <p className="text-sm text-gray-700">
        Yellow means this letter is in the word, but not in this location. It
        ignores diacritics, so "ā" will turn yellow if "a" is in the word.
        Likewise, "t" will if "ṭh" is.
      </p>
